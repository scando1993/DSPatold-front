<template>
	<div class="main-content">
		<breadcumb :page="'New Webhook'" :folder="''"/>
...
export default {
	...
	methods: {
		onSubmit(evt) {
			...
			this.$swal.fire({
				title: "Are you sure?",
				text: "This will add a new webhook.",
				icon: "question",
				showClass: {
					popup: '',
					backdrop: ''
				...
				.then(function (result) {
					if (result.value) {
						_this.$swal.fire({
							...
							text: 'This Webhook has been added successfully!',
							icon: 'success',
							preConfirm: function() {
								_this.$router.push('/app/webhooks');
							}
						});
					}
				});
