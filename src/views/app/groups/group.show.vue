					...
					<b-container fluid>
						<b-form id="form-1" @submit="onSubmit">
							...
							<b-form-group>
								<b-form-row>
									<b-col cols="6">
										<!-- <b-button variant="danger"><b-icon icon="plus"></b-icon> Bulk Import Users</b-button> -->
										<b-form-file v-model="file" placeholder="Choose a file or drop it here..." drop-placeholder="Drop file here..." @change="importUsers" browse-text="Bulk Import Users"></b-form-file>
									</b-col>
						...
						<form @submit="addTarget">
							<b-form-row >
								...
								<b-col>
									<b-button type="submit" variant="danger"><b-icon icon="plus"></b-icon> Add</b-button>
								</b-col>
							</b-form-row>
						</form>
						<div class="pt-4">
...
export default {
	...
	methods: {
		...
		onSubmit(evt) {
			...
			this.$swal.fire({
				title: "Are you sure?",
				text: "This will update this group.",
				icon: "question",
				showClass: {
					popup: '',
					backdrop: ''
				...
				.then(function (result) {
					if (result.value) {
						_this.$swal.fire(
							...
							'This group has been edited successfully!',
							'success');
					}
				});
		},
