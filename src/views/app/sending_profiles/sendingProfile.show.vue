<template>
	<div class="main-content">
		<breadcumb :page="'Sending Profile'" :folder="''"/>
...
export default {
	...
	methods: {
		...
		onSubmit(evt) {
			...
			this.$swal.fire({
				title: "Are you sure?",
				text: "This will update this sending profile.",
				icon: "question",
				showClass: {
					popup: '',
					backdrop: ''
				...
				.then(function (result) {
					if (result.value) {
						_this.$swal.fire(
							...
							'This profile has been edited successfully!',
							'success');
					}
				});
		},
