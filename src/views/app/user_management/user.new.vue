<template>
	<div class="main-content">
		<breadcumb :page="'New User'" :folder="''"/>
					...
					.then(function (result) {
						if (result.value) {
							_this.$swal.fire({
								...
								text: 'This user has been added successfully!',
								icon: 'success',
								preConfirm: function() {
									_this.$router.push('/app/users');
								}
							});
						}
					});
